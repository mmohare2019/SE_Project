...
import FormStyle from "../Form.style";
   ...
   // Edit team button
    ...
    <View style={FormStyle.groupView}>
      <Text style={MainStyle.emphasisText}> Admit Player </Text>
    </View>
    <View style={FormStyle.groupView}>
    ...
    <View style={FormStyle.groupView}>
      <Text style={MainStyle.emphasisText}> View Playoffs </Text>
    </View>
    <View style={FormStyle.groupView}>
      <Text style={MainStyle.emphasisText}> Keep Score </Text>
    </View>
    <View style={FormStyle.groupView}>
      <Text style={MainStyle.emphasisText}> View Roster </Text>
    </View>
